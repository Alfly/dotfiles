...
PS1="\n${COLOR_BLUE}#${COLOR_DEFAULT} ${COLOR_MAGENTA}\\u@\$(machine_name)${COLOR_DEFAULT} ${COLOR_YELLOW}\w${COLOR_DEFAULT}\$(if [ \$? -ne 0 ]; then echo \"${COLOR_RED}!${COLOR_DEFAULT} \"; fi)${COLOR_DEFAULT} ${COLOR_BLUE}>>>${COLOR_DEFAULT} "
